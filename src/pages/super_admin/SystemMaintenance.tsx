              ...
              <div key={idx} className="p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Uptime: {s.uptime}</div>
                  </div>
                </div>
                <div className="text-right">
                  <Badge color={s.status === 'operational' ? 'green' : 'red'}>{s.status.toUpperCase()}</Badge>
                  <div className="text-[10px] text-gray-500 mt-1">Load: {s.load}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-white rounded-xl border border-amber-500/10">
                <div className="text-sm font-bold text-gray-900">Database Optimization</div>
                <p className="text-xs text-gray-500 mt-1">Dec 12, 2024 • 02:00 AM UTC (Est. 2h)</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="p-3 rounded-xl bg-gray-100 text-xs font-bold hover:bg-gray-200 transition-colors">Clear Cache</button>
              <button className="p-3 rounded-xl bg-gray-100 text-xs font-bold hover:bg-gray-200 transition-colors">Rebuild Index</button>
              <button className="p-3 rounded-xl bg-gray-100 text-xs font-bold hover:bg-gray-200 transition-colors">Restart Load Balancer</button>
