      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-md">
        <div className="flex flex-wrap border-b border-gray-200">
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${activeSection === 'leave'
          ...
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${activeSection === 'employee'
          ...
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${activeSection === 'termination'
          ...
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${activeSection === 'resignation'
