...
export const AdminHub = () => {
                    ...
                    const formattedAdmins: User[] = employees
                        ...
                        .map((emp: any) => {
                            ...
                            return {
                                ...
                                role: (roleVal === 'SUPER_ADMIN' ? 'SUPER_ADMIN' : 'ADMIN') as any,
                                status: statusValue,
    ...
    const filteredAdmins = useMemo(() => {
        return admins.filter(a => {
            // Ensure only admins are displayed
        ...
        try {
            ...
            if (isNew) {
                ...
                const adminPayload = {
                    ...
                    role: 'ADMIN',
                    userType: formState.employmentType,
                ...
                const result = await usersApi.registerAdmin(adminPayload, selectedFile || undefined);
