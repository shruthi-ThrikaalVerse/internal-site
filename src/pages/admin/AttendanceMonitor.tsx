      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-6 border-b flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gray-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black text-gray-900 uppercase tracking-tighter">Live Attendance Feed</h2>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b bg-white text-left">
                <th className="py-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest">Employee Profile</th>
                <th className="py-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest text-center">Clock-In</th>
                <th className="py-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest text-center">Clock-Out</th>
                <th className="py-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest text-center">Total Hours</th>
                <th className="py-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest">Status Label</th>
                <th className="py-4 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest">Origin</th>
              </tr>
            </thead>
                ...
                filteredFeed.map((record: any) => (
                  <tr key={record.employeeId} className="hover:bg-indigo-50/30 transition-colors group">
                    <td className="py-5 px-8">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-gray-100 rounded-xl flex items-center justify-center text-xs font-black text-gray-400 border border-gray-200 group-hover:bg-white group-hover:text-indigo-600 transition-colors">
                          {record.name?.charAt(0) || '?'}
                        </div>
                        <div>
                          <p className="font-black text-gray-800 leading-none mb-1 text-sm">{record.name}</p>
                          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">{record.employeeId}</p>
                        </div>
                      </div>
                    </td>

                    <td className="py-5 px-8 text-xs font-bold text-gray-600 text-center">{record.checkIn}</td>
                    ...
                    <td className="py-5 px-8 text-xs font-medium text-gray-500">
                      <div className="flex items-center gap-2 text-gray-400">
                        <Icon name="MapPin" className="w-3.5 h-3.5 text-gray-200" />
                        <span className="text-[10px] font-bold uppercase tracking-wide">{record.location || 'HQ Office'}</span>
                      </div>
                    </td>
                  </tr>
                ))
                ...
                <tr>
                  <td colSpan={6} className="py-24 text-center">
                    <div className="w-20 h-20 bg-gray-50 rounded-[28px] flex items-center justify-center mx-auto mb-6">
                      <Icon name="Users" className="w-10 h-10 text-gray-200" />
                    </div>
