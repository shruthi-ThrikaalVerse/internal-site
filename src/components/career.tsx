...
const Career = () => {
  return (
    <div className="container mx-auto" id="career" >
      ...
      <div className="pt-3 text-center"><button className="px-10 py-4 border border-white/10 hover:border-teal-500 text-white rounded-full transition-all bg-white/5 hover:bg-teal-500/10">View All Projects</button></div>
    </div>
  );
};
